        ...
        <aside class="w-64 shrink-0 hidden lg:block">
            ...
            >
                ...
                <button
                    ...
                    class="flex items-center gap-3 px-4 py-3 rounded-xl font-medium transition-all hover:bg-error/5 hover:text-error group mt-4 w-full text-left"
                    aria-label="Sign Out"
                >
                        <svg
                            class="w-5 h-5 opacity-50 group-hover:opacity-100"
                ...
                <div class="border-t border-base-content/5 mt-4 pt-4">
                    <LocaleSwitcher />
                </div>
            </div>
        </aside>
